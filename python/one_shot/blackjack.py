...
#     print("Welcome to Blackjack!")
#     for i in range(2):
#         cards["user"].append(genete_card())
#         cards["computer"].append(genete_card())
    
#     print(f"Your cards: {cards['user']}, current score: {sum(cards['user'])}")
...
#     user_score = sum(cards["user"])
#     computer_score = sum(cards["computer"])
    
#     print(f"Your final hand: {cards['user']}, final score: {user_score}")
#     print(f"Computer's final hand: {cards['computer']}, final score: {computer_score}")
